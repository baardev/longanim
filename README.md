...
# Originally this was titles “Instructions to create long-form video from multiple short clips”, but is now a fettuccine of notes, commands, todo lists, and a general notepad.  
...
export COMMANDLINE_ARGS="--port 8093"
python launch.py --listen --port 8093
```
On LOCAL machine, start the ssh tunnel
```bash
ssh -L 127.0.0.1:8093:127.0.0.1:8093 torcho@10.68.19.55
```
Site accessable at http://127.0.0.1:8093/
